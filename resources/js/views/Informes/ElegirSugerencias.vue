<template>
  <div>
    ...
    <p class="colorp" style="font-size: 15px">
      Sugerencias ordenadas por la mas aplicada , selecionar una o varias
    </p>
    <select
      v-model="sugerenciasSeleccionadas"
      class="form-select"
      multiple
    ...
    >
      <option
        ...
        :content="
          'Esta sugerencia fue aplicada ' +
          sugerencia.suggestion.puntaje +
          ' veces con exito'
        "
        v-tippy="{
      ...
      >
        ...
        <small v-if="sugerencia.cantStock > 0">
          - ({{ sugerencia.marca }}.{{ sugerencia.modelo }})</small
        >
...
export default {
  ...
  updated() {
    console.log(this.arraysugerencias);
