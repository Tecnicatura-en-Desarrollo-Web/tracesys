            ...
            <div class="columns align-content-end">
                <form method="POST" @submit.prevent="iniciarSesion">
                    <div class="form-group ">
                        ...
                        <input type="email" class="form-control" id="username2" name="email" placeholder="Ingrese email">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password" class="form-control" id="password2" name="contrasena" placeholder="Ingrese Password" >
                    </div>
                    <button type="submit" class="btn btn-primary" @click="mostrarMensaje()">Inicar Sesion</button>
                </form>
                <div>
                    <hr>
