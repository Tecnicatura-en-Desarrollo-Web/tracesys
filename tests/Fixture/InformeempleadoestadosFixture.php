...
class InformeempleadoestadosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['informeempleadoestado_id_propio', 'informeempleadoestado_id', 'employee_id', 'state_id', 'sector_id'], 'length' => []],
            ...
            'informeempleadoestados_ibfk_4' => ['type' => 'foreign', 'columns' => ['sector_id'], 'references' => ['sectors', 'sector_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'state_id' => 1,
                'sector_id' => 1,
                'created' => '2021-11-01 00:18:07',
                'modified' => '2021-11-01 00:18:07',
                'ultimoEstado' => 1,
            ],
        ];
        parent::init();
