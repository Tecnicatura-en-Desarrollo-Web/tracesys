...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'employees_ibfk_2' => ['type' => 'foreign', 'columns' => ['employee_id'], 'references' => ['users', 'user_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'employees_ibfk_1' => ['type' => 'foreign', 'columns' => ['profile_id'], 'references' => ['profiles', 'profile_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
