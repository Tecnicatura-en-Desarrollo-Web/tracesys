...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'apellido' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        'contrasena' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'telefono' => 1,
                'created' => '2021-10-19 02:45:32',
                'modified' => '2021-10-19 02:45:32',
            ],
        ];
        parent::init();
    }
