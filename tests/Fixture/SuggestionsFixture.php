...
class SuggestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre_sugerencia' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-10-19 02:46:30',
                'modified' => '2021-10-19 02:46:30',
            ],
        ];
        parent::init();
    }
